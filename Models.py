...
class BaseLine(nn.Module): #Change the name for each model
    ...
    def __init__(self, vocab_size, emb_dim, K, feat_dim, hid_dim, out_dim, pretrained_wemb):
        ...
        self.wembed.weight.data.copy_(torch.from_numpy(pretrained_wemb))        # initialize word embedding layer weights
